...
<title> Update Casher Registration Board</title>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Update Casher Registration</h2>
<body>
<form action="cashupdate.php" method="post">
...
if(isset($_POST['update'])){
    ...
    $update ="UPDATE Cash set CashID=".$admid.",FName='".$fname."',LName='".$lname."',Gender='".$gender."',Email='".$email."',
