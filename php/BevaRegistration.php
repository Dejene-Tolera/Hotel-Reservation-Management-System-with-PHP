...
<form action="BevaRegistration.php" method="post">
 ...
 <select name="bevetype" id="bevetype" required>
    ...
    <option value="Hot bevarage">Hot bevarage</option>
 ...
 <select name="beveprice" id="beveprice" required>
	...
	<br> <br>
 <input style="margin-left: 100px;background-color: green;color: white; font-size:20px;" type="submit" onclick="Registration(this.form)" value="Register" name="register">
