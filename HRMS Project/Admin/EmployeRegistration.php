	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Employee Registration Form </h2>
<body>
<form action="EmployeRegistration.php" method="post">
...
$insert ="INSERT INTO Employee values(".$empid.",'".$fname."','".$lname."','".$gender."','".$email."',
".$phonee.",'".$addr."',".$sal.")";
