...
<title>View Customer Feedback Board</title>
...
<div id="container">
    ...
    <div id="content_area">
		<div id="left_col">
        <h2>Feedback&nbsp;/View Customer Feedback&nbsp;</h2>
...
<head>
<h2 style="margin-left: 70px;color: blue;width: 500px;">View Feedbacked by Customer </h2>
<body>
<table>
<tr>
    <th>FeedbackID</th>
