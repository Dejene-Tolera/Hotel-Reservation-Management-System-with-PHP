...
<div id="container">
	<div id="header">
		...
		<div id="top_info">
		<marquee><h2>Hotel Reservation Management System</h2></marquee>
		</div>
	...
	<form action="customAccount.php" method="post">
        ...
        <label style="margin-left: 41px;" for="">Password<span style="color: red;"><sup>*</sup></span>:</label>
         ...
         <br> <br>
         <input style="margin-left: 130px;background-color: green;color: white; font-size: 23px;" type="submit" name="register" value="Signup">
      
       <a href="login.php" style="margin-left: 20px;text-decoration: none;font-size: 23px;">Login</a>
       </p>
    </form>
</div>
</div>    
