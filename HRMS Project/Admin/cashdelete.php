...
<title> Delete Casher Registration Board</title>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Delete Casher Registration</h2>
<body>
<form action="cashdelete.php" method="post">
...
if(isset($_POST['delete'])){
    ...
    $delete ="DELETE FROM Casher WHERE CashID ='$cashid'";
