...
<title>Administrator Registration Board</title>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Administrator Registration Form </h2>
<body>
...
<label for="">Phone Number<span style="color: red;"><sup>*</sup></span>:</label>
    <select name="country" required>
            <option value="select">--select--</option>
             <option value="ETH">ETH(+251)</option>
            <option value="US">US(+458)</option>
            <option value="UK">UK(+387)</option>
            <option value="AUS">AUS(+862)</option>
            </select>
...
<label style="margin-left: 41px;" for="">Password<span style="color: red;"><sup>*</sup></span>:</label>
 ...
 <br> <br>
 <input style="margin-left: 130px;background-color: green;color: white;" type="submit" onclick="Registration(this.form)" value="Register" name="register">
...
if(isset($_POST['register'])){
    ...
    if($pass == $conpass){ 
$insert ="INSERT INTO Administrator values(".$admid.",'".$fname."','".$lname."','".$gender."','".$email."',
