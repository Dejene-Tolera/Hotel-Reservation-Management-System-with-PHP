...
<title>View Casher Feedback Board</title>
...
<div id="container">
    ...
    <div id="content_area">
		<div id="left_col">
        <h2>Feedback&nbsp;/View Casher Feedback&nbsp;</h2>
...
<head>
<h2 style="margin-left: 70px;color: blue;width: 500px;">View Feedbacked by Casher </h2>
<body>
<table>
<tr>
    <th>FeedbackID</th>
...
$sql="SELECT * FROM CasherFeedback";
$result=$connection->query($sql);
if($result->num_rows>0){
while($row=$result->fetch_assoc()){
    echo"<tr><td>".$row['FeedbackID']." "."</td><td>".$row['FeedbackName']." "."</td><td>".$row['FeedbackDate']." "."</td><td>".$row['FeedbackPurpose']." "."</td></tr>";
}
}
