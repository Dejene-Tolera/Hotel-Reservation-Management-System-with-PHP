...
<title>Customer Feedback Submit Board</title>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Customer Feedback Form </h2>
<body>
<form action="castFeedSubmit.php" method="post">
...
$insert ="INSERT INTO CustomerFeedback values(".$fedid.",'".$fedname."','".$feddate."','".$fedpurpose."')";
