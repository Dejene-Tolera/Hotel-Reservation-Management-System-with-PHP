	...
	<div id="content_area">
	   ...
	   <ul>
		...
		<div id="right_col">
				   ...
				   <dl>
                    <dt style="margin-left: 30px;color:blue;font-size:22px;">Customer Get Service</dt>
                    <dd>
                    <ul type="circle">
                     <li>Every Customer can served. </li>
                     <li>Customer can reserved at that Hotel.</li>
                     <li>Customer can eat different food.</li>
                     <li>Customer can drink different type.</li>
