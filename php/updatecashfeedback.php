...
<title>Update Casher Feedback Board</title>
...
<div id="container">
	<div id="header">
		...
		<ul>
            ...
            <li><a href="cashfeedback.php"style="margin-left: 10px" id= "active">Feedback</a></li>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Update Casher Feedback Form </h2>
<body>
<form action="updatecashfeedback.php" method="post">
...
<input type="text" name="feedid" id="feedid" required placeholder="feed id"  pattern="[a-zA-Z0-9]{3,}" title="please enter more than three letters">
 ...
 <textarea name="feedpurpose" id="feedpurpose"required placeholder="like this...."rows="5px" cols="30px" > </textarea>
	<br> <br>
 <input style="margin-left: 130px;background-color: green;color: white;font-size: 20px;" type="submit" value="Update" name="update">
...
$update ="UPDATE CasherFeedback set FeedbackID='".$fedid."',FeedbackName='".$fedname."',FeedbackDate='".$feddate."',FeedbackPurpose='".$fedpurpose."' where FeedbackID='$fedid'";
