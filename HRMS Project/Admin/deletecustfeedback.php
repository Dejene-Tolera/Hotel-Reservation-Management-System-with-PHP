...
<title>Delete Customer Feedback Board</title>
...
<div id="container">
    ...
    <div id="content_area">
		<div id="left_col">
        <h2>Feedback&nbsp;/Delete Customer Feedback&nbsp;</h2>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 200px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="color: blue; width:600px;">Delete Feedbacked by Customer</h2>
<body>
<form action="deletecustfeedback.php" method="post">
...
$delete ="DELETE FROM CustomerFeedback WHERE FeedbackID='$feedid'";
