	...
	<div id="content_area">
	   ...
	   <ul>
		...
		<div id="right_col">
				   ...
				   <dl>
                    <dt style="margin-left: 30px;color:blue;font-size:22px;">About Casher</dt><br/>
                    <dd>
                    Casher Response to collect  the money in the Hotel and calculate the capital of 
                    the Hotel that to be provide the service and other importance of the Hotel.
                    </dd>
