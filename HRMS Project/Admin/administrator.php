	...
	<div id="content_area">
	   ...
	   <ul>
		...
		<div id="right_col">
				   ...
				   <dl>
                    <dt style="margin-left: 30px;color:blue;">Administrator Function</dt><br/>
                    <dd>
						Administrator manage all employee under them and record the daily ate food,record the daily 
					material that there as before, take the daily attendace of the employee and calculate 
					thier salary depend on the number of their attendace.
                    </dd>
