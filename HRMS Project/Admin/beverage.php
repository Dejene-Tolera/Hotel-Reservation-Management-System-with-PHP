	...
	<div id="content_area">
	   ...
	   <ul>
		...
		<div id="right_col">
				   ...
				   <dl>
                    <dt style="margin-left: 30px;color:blue;">Beverage Function</dt><br/>
                    <dd>
						Employee Response to give and bring the asked by customer and other employee and prepare a material 
                  clean the material and prepare a food.
                    </dd>
