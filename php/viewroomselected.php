...
<title>View Room Registration Board</title>
...
<div id="container">
    ...
    <div id="content_area">
		<div id="left_col">
        <h2>Customer&nbsp;/View Room Selected&nbsp;</h2>
...
<head>
<h2 style="margin-left: 70px;color: blue;width: 500px;">View Room Selected by Customer </h2>
<body>
<table>
<tr>
    <th>Room_No</th>
...
while($row=$result->fetch_assoc()){
    echo"<tr><td>".$row['Room_No']." "."</td><td>".$row['Room_Type']." "."</td><td>".$row['Room_Floor']." "."</td>
    <td>".$row['Room_Price']." "."</td></tr>";
}
}
