...
<title>View Customer Registration Board</title>
...
<head>
<h2 style="margin-left: 70px;color: blue;width: 500px;">View Customer Account Form </h2>
<body>
<table>
<tr>
    <th>CustID</th>
...
while($row=$result->fetch_assoc()){
    echo"<tr><td>".$row['CustID']." "."</td><td>".$row['FName']." "."</td><td>".$row['LName']." "."</td>
    <td>".$row['Gender']." "."</td><td>".$row['Email']." "."</td><td>".$row['Phone']." "."</td><td>".$row['Address']." "."</td>
    <td>".$row['Username']." "."</td><td>".$row['Password']." "."</td></tr>";
}
}
