...
<title>Delete Administrator Registration Board</title>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 200px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="color: blue; width:600px;">Delete Administrator Registration by AdminID </h2>
<body>
...
$delete ="DELETE FROM Administrator WHERE AdmID='$admid'";
