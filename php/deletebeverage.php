...
<title>Delete Beverage Registration Board</title>
	...
	<div id="content_area">
		...
		<div class="right_info" style="margin-right: 100px;">
                    ...
                    <dd>
                     <html>
<head>
<h2 style="margin-left: 50px;color: blue; margin-left: 10px;">Delete Beverage Registration</h2>
<body>
<form action="deletebeverage.php" method="post">
 ...
 <select name="bevename" id="bevename" required>
    ...
    <option value="Netcafe">Netcafe</option>
    <option value="Anbesa Bera">Anbesa Bera</option>
    <option value="Sink Bera">Sink Bera</option>
    <option value="Asmera Bera">Asmera Bera</option>
    <option value="Georgis Bera">Georgis Bera</option>
...
if(isset($_POST['delete'])){
    ...
    $delete ="DELETE FROM Beverage WHERE Beve_Name='$bvname'";
