	...
	<div id="content_area">
	   ...
	   <ul>
		...
		<div id="right_col">
				   ...
				   <dl>
                    <dt style="margin-left: 30px;color:blue;font-size:22px;">About Food </dt><br/>
                    <dd>
						Food used to eat in the hotel and useful for our custome.
						Food is prepared by hotel employee.
                    </dd>
